...
CORS(app, resources={r"/chat": {"origins": ["http://localhost:5000", "http://localhost:3000", "https://localhost:5173","https://frontend-movie-r6pdprw0i-minsunducks-projects.vercel.app", "https://frontend-movie-jade.vercel.app"]}})
